...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""bindings"": [
                {
                    ""name"": ""2D Vector"",
                    ""id"": ""7010d246-0672-47c4-a51d-d6a75a8b7bba"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""761c3993-fa25-42e4-bc50-1900ea079c46"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""9c154ba1-1ecd-4b92-b0c5-e94725755afb"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""3b975462-7053-492d-b6e9-2b6e6514f769"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""b62c199b-2595-4baf-b1a4-cd1354a7e33b"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ~@InputSystem_Actions()
    {
        UnityEngine.Debug.Assert(!m_Heli.enabled, "This will cause a leak and performance issues, InputSystem_Actions.Heli.Disable() has not been called.");
    ...
    public struct HeliActions
    {
        ...
        /// <summary>
        /// Implicitly converts an <see ref="HeliActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        ...
        public void AddCallbacks(IHeliActions instance)
        {
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="HeliActions.UnregisterCallbacks(IHeliActions)" />.
        /// </summary>
        /// <seealso cref="HeliActions.UnregisterCallbacks(IHeliActions)" />
        public void RemoveCallbacks(IHeliActions instance)
        {
            if (m_Wrapper.m_HeliActionsCallbackInterfaces.Remove(instance))
        ...
        /// </remarks>
        /// <seealso cref="HeliActions.AddCallbacks(IHeliActions)" />
        /// <seealso cref="HeliActions.RemoveCallbacks(IHeliActions)" />
        /// <seealso cref="HeliActions.UnregisterCallbacks(IHeliActions)" />
        public void SetCallbacks(IHeliActions instance)
        {
            foreach (var item in m_Wrapper.m_HeliActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_HeliActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="HeliActions" /> instance referencing this action map.
    /// </summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "Heli" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="HeliActions.AddCallbacks(IHeliActions)" />
    /// <seealso cref="HeliActions.RemoveCallbacks(IHeliActions)" />
